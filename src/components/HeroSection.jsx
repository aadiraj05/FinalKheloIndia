...
import BadmintonImage from '/src/assets/Badminton-amico.svg';
import ArcheryImage from '/src/assets/Archery-amico.svg';
...
const HeroSection = () => {
  ...
  return (
    ...
    <h2 className="text-4xl font-semibold text-[#b86cc4] ml-[110px]"><span className="text-red-600 text-5xl font-semibold       inline-block align-middle ml-2">
      ...
      {/* <SlotDropdownButton /> */}
          <button onClick={handleBookTicket} className=" flex items-center gap-x-2 border bg-gradient-to-r from-[#d878b1] to-[#38a5dd] text-white px-6 py-2 rounded-lg transition transform duration-300 ease-in-out hover:bg-[#a36bc5] hover:scale-110 ">
          <HiTicket />
